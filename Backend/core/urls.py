...
schema_view = get_schema_view(
    openapi.Info(
        title="Catálogo El Vecino API",
        default_version='v1',
        description="Documentación de la API de Catálogo El Vecino (Productos, Categorías, Promociones y Combos)",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="contacto@catalogoelvecino.com"),
